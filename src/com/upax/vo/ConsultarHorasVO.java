...
public class ConsultarHorasVO {
	...
	public ConsultarHorasVO(int eMPLOYEE_ID, String sTART_DATE, String eND_DATE, Integer p_RESULT,
	...
	public String toString() {
		return "ConsultarHorasVO [EMPLOYEE_ID=" + EMPLOYEE_ID + ", START_DATE=" + START_DATE + ", END_DATE=" + END_DATE
